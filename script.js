...
let veryOldInventorsFiltered = veryOldInventors.filter(function(inventor) {
  return inventor.year >= 1500 && inventor.year <= 1599;
});

// Check your return value:
console.log('Exercise 1 My Result: ', veryOldInventorsFiltered);
...
let isEveryone19OrOlder = false;

// Enter your solution code here:

currentYear = new Date().getFullYear();

 isEveryone19OrOlder = devs.every(person => (currentYear - person.year) >= 19);
...
let travelMethodCounts = { car: 5, truck: 3, bike: 2, walk: 2, van: 2 }
